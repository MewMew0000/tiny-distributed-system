...
func RegisterService(r Registration) error {
	...
	if res.StatusCode != http.StatusOK {
		return fmt.Errorf("fail to register service. Registry service "+"responded with code %v ", res.StatusCode)
	}
	return nil
}
...
func ShutdownService(url string) error {
	...
	if res.StatusCode != http.StatusOK {
		return fmt.Errorf("fail to cancel service. Cancel service "+"responded with code %v ", res.StatusCode)
	}
	return nil
}
